...
def get_response(message):
    ...
    response_list = [
        process_message(message, ['hello', 'hi', 'hey'], 'Hey there! I am ReShi, How can I help You?'),
        process_message(message, ['bye', 'goodbye'], 'Goodbye!'),
        process_message(message, ['how', 'are', 'you'], 'I\'m doing fine thanks!'),
        process_message(message, ['your', 'name'], 'My name is ReShi, nice to meet you!'),
